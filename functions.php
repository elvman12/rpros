 ...
 */
function orbisius_ct_resistance_pros_child_theme_enqueue_styles() {
    $parent_style = 'orbisius_ct_resistance_pros_parent_style';
    $parent_base_dir = 'mediacenter';
...
add_action( 'wp_enqueue_scripts', 'orbisius_ct_resistance_pros_child_theme_enqueue_styles' );
